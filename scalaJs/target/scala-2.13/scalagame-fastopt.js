...
class $c_Lgame$ extends $c_O {
  main__AT__V(args) {
    $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().ontouchmove = ((arg1$2) => {
      const this$3 = $m_s_Console$();
      const this$4 = this$3.out__Ljava_io_PrintStream();
      this$4.java$lang$JSConsoleBasedPrintStream$$printString__T__V((arg1$2 + "\n"))
    })
  };
}
