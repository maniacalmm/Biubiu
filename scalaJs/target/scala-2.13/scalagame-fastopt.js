...
const $p_LBattleShip__updateBulletStates__V = (function($thiz) {
  $thiz.LBattleShip__f_allBullets = $as_scm_Buffer($as_sc_IterableOps($thiz.LBattleShip__f_allBullets.map__F1__O(new $c_sjsr_AnonFunction1(((this$1) => ((b$2) => {
    const b = $as_LBullet(b$2);
    const x = (b.LBullet__f_x + b.LBullet__f_xV);
    const y = (b.LBullet__f_y + b.LBullet__f_yV);
    const xV = b.LBullet__f_xV;
    const yV = b.LBullet__f_yV;
    return new $c_LBullet(x, y, xV, yV)
  }))($thiz)))).filter__F1__O(new $c_sjsr_AnonFunction1(((this$2) => ((b$3$2) => {
    const b$3 = $as_LBullet(b$3$2);
    return (b$3.LBullet__f_y > 0.0)
  }))($thiz))))
});
class $c_LBattleShip extends $c_O {
  constructor(x, y, ctx) {
    super();
    this.LBattleShip__f_x = 0.0;
    this.LBattleShip__f_y = 0.0;
    this.LBattleShip__f_ctx = null;
    this.LBattleShip__f_health = 0.0;
    this.LBattleShip__f_energy = 0.0;
    this.LBattleShip__f_allBullets = null;
    this.LBattleShip__f_context = null;
    this.LBattleShip__f_xV = 0.0;
    this.LBattleShip__f_xY = 0.0;
    this.LBattleShip__f_x = x;
    this.LBattleShip__f_y = y;
    this.LBattleShip__f_ctx = ctx;
    this.LBattleShip__f_health = 100.0;
    this.LBattleShip__f_energy = 100.0;
    this.LBattleShip__f_allBullets = $as_scm_Buffer($m_scm_Buffer$().apply__sci_Seq__sc_SeqOps($m_sci_Nil$()));
    this.LBattleShip__f_context = ctx;
    this.LBattleShip__f_xV = 0.0;
    this.LBattleShip__f_xY = 0.0;
    this.updatePostition__D__D__V(this.LBattleShip__f_x, this.LBattleShip__f_y)
  };
  drawBullet__V() {
    const this$1 = this.LBattleShip__f_allBullets;
    const it = this$1.iterator__sc_Iterator();
    while (it.hasNext__Z()) {
      const arg1 = it.next__O();
      const x$1 = $as_LBullet(arg1);
      x$1.draw__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(this.LBattleShip__f_context)
    }
  };
  drawShip__V() {
    this.LBattleShip__f_ctx.beginPath();
    this.LBattleShip__f_ctx.arc(this.LBattleShip__f_x, this.LBattleShip__f_y, 20.0, 0.0, 6.283185307179586);
    this.LBattleShip__f_ctx.fillStyle = "#000000";
    this.LBattleShip__f_ctx.fill()
  };
  fire__V() {
    const bullet = new $c_LBullet(this.LBattleShip__f_x, this.LBattleShip__f_y, this.LBattleShip__f_xV, ((-30.0) + this.LBattleShip__f_xY));
    const this$1 = this.LBattleShip__f_allBullets;
    this$1.addOne__O__scm_Growable(bullet);
    $p_LBattleShip__updateBulletStates__V(this)
  };
  updatePostition__D__D__V(x, y) {
    this.LBattleShip__f_xV = (x - this.LBattleShip__f_x);
    this.LBattleShip__f_xY = (y - this.LBattleShip__f_y);
    this.LBattleShip__f_x = x;
    this.LBattleShip__f_y = y
  };
}
const $d_LBattleShip = new $TypeData().initClass({
  LBattleShip: 0
}, false, "BattleShip", {
  LBattleShip: 1,
  O: 1
});
$c_LBattleShip.prototype.$classData = $d_LBattleShip;
const $s_Lgame__main__AT__V = (function(args) {
  $m_Lgame$().main__AT__V(args)
});
class $c_Lgame$ extends $c_O {
  clearCtx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__Lorg_scalajs_dom_raw_HTMLCanvasElement__V(ctx, canvas) {
  ...
  main__AT__V(args) {
    ...
    const this$1 = $uD($m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().innerWidth);
    canvas.setAttribute("width", ("" + this$1));
    const this$3 = $uD($m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().innerHeight);
    canvas.setAttribute("height", ("" + this$3));
    canvas.setAttribute("id", "ctx");
    $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body.appendChild(canvas);
    const c = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("ctx");
    const ctx = c.getContext("2d");
    const ship = new $c_LBattleShip(($uD($m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().innerWidth) / 2.0), (0.9 * $uD($m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().innerHeight)), ctx);
    $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().onmousemove = ((ship$1) => ((arg1$2) => {
      $m_Lgame$().game$$$anonfun$main$1__Lorg_scalajs_dom_raw_MouseEvent__LBattleShip__V(arg1$2, ship$1)
    }))(ship);
    $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().setInterval(((ship$1$1) => (() => {
      ship$1$1.fire__V()
    }))(ship), 50.0);
    $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().setInterval(((ctx$1, c$1, ship$1$2) => (() => $m_Lgame$().game$$$anonfun$main$5__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__Lorg_scalajs_dom_raw_HTMLCanvasElement__LBattleShip__O(ctx$1, c$1, ship$1$2)))(ctx, c, ship), 5.0)
  };
  game$$$anonfun$main$1__Lorg_scalajs_dom_raw_MouseEvent__LBattleShip__V(e, ship$1) {
    ship$1.updatePostition__D__D__V($uD(e.clientX), $uD(e.clientY))
  };
  game$$$anonfun$main$5__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__Lorg_scalajs_dom_raw_HTMLCanvasElement__LBattleShip__O(ctx$1, c$1, ship$1) {
    $m_Lgame$().clearCtx__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__Lorg_scalajs_dom_raw_HTMLCanvasElement__V(ctx$1, c$1);
    ship$1.drawBullet__V();
    ship$1.drawShip__V()
  };
}
const $d_Lgame$ = new $TypeData().initClass({
  Lgame$: 0
}, false, "game$", {
  Lgame$: 1,
  O: 1
...
class $c_LBullet extends $c_O {
  constructor(x, y, xV, yV) {
    super();
    this.LBullet__f_x = 0.0;
    this.LBullet__f_y = 0.0;
    this.LBullet__f_xV = 0.0;
    this.LBullet__f_yV = 0.0;
    this.LBullet__f_x = x;
    this.LBullet__f_y = y;
    this.LBullet__f_xV = xV;
    this.LBullet__f_yV = yV
  };
  draw__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(ctx) {
    ctx.beginPath();
    ctx.arc(this.LBullet__f_x, this.LBullet__f_y, 5.0, 0.0, 6.283185307179586);
  ...
  productElement__I__O(x$1) {
    switch (x$1) {
      case 0: {
        return this.LBullet__f_x;
        break
      }
      case 1: {
        return this.LBullet__f_y;
        break
      }
      case 2: {
        return this.LBullet__f_xV;
        break
      }
      case 3: {
        return this.LBullet__f_yV;
        break
      }
      default: {
  ...
  equals__O__Z(x$1) {
    if ((this === x$1)) {
      return true
    } else if ((x$1 instanceof $c_LBullet)) {
      const Bullet$1 = $as_LBullet(x$1);
      return ((((this.LBullet__f_x === Bullet$1.LBullet__f_x) && (this.LBullet__f_y === Bullet$1.LBullet__f_y)) && (this.LBullet__f_xV === Bullet$1.LBullet__f_xV)) && (this.LBullet__f_yV === Bullet$1.LBullet__f_yV))
    } else {
      return false
    }
  };
}
function $as_LBullet(obj) {
  return (((obj instanceof $c_LBullet) || (obj === null)) ? obj : $throwClassCastException(obj, "Bullet"))
}
function $isArrayOf_LBullet(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LBullet)))
}
function $asArrayOf_LBullet(obj, depth) {
  return (($isArrayOf_LBullet(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "LBullet;", depth))
}
const $d_LBullet = new $TypeData().initClass({
  LBullet: 0
}, false, "Bullet", {
  LBullet: 1,
  O: 1,
...
$c_LBullet.prototype.$classData = $d_LBullet;
...
class $c_scm_Buffer$ extends $c_sc_SeqFactory$Delegate {
  constructor() {
    super();
    $ct_sc_SeqFactory$Delegate__sc_SeqFactory__(this, $m_sjs_js_WrappedArray$())
  };
}
const $d_scm_Buffer$ = new $TypeData().initClass({
  scm_Buffer$: 0
...
$c_sjs_js_WrappedArray.prototype.$classData = $d_sjs_js_WrappedArray;
$L0 = new $c_RTLong(0, 0);
$s_Lgame__main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
//# sourceMappingURL=scalagame-fastopt.js.map
